          ...
          <VStack space="lg">
            <Box>
              ...
              <Input variant="rounded" size="md">
                <InputField placeholder="e.g. Berkeley – Unit 1" placeholderTextColor="white" color="white" />
              </Input>
            </Box>
            ...
            <Box>
              ...
              <Input variant="rounded" size="md">
                <InputField placeholder="e.g. SFO Terminal 2" placeholderTextColor="white" color="white" />
              </Input>
            </Box>
            ...
            <Box>
              ...
              <Input variant="rounded" size="md">
                <InputField placeholder="e.g. June 20" placeholderTextColor="white" color="white" />
              </Input>
            </Box>
            ...
            <Box>
              ...
              <Input variant="rounded" size="md">
                <InputField placeholder="e.g. 4:00–6:00 PM" placeholderTextColor="white" color="white" />
              </Input>
            </Box>
            ...
            <Box>
              ...
              <Input variant="rounded" size="md">
                <InputField placeholder="Optional" placeholderTextColor="white" color="white" />
              </Input>
            </Box>
  
            <Button mt="$4" size="lg" action="primary" variant="solid" borderRadius="$full">
