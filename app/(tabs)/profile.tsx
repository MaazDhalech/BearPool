          ...
          >
            ...
            <VStack space="lg" alignItems="center">
              ...
              <TouchableOpacity
                ...
                style={{
                  alignItems: "center",
                  marginBottom: isEditing ? SPACE.sm : 0,
                }}
              >
                ...
                {isEditing && (
                  <Text
                    style={{
                      color: avatarUploading ? "#666" : ACCENT,
              ...
              {!isEditing && (
                ...
                >
                  ...
                  {display.username ? (
                    <Text
                      style={{ color: "#a0a0a0", fontSize: TYPE.size.body }}
                    >
                      @{display.username}
                    </Text>
                  ) : null}
              ...
              <VStack space="sm" w="100%" style={{ marginTop: SPACE.lg }}>
                {isEditing ? (
                  <>
                    <Text
                      style={{ color: "#a0a0a0", fontSize: TYPE.size.caption }}
                    >
                      First Name
                    </Text>
                    <Input
                      ...
                      {(["M", "F", "NB"] as Gender[]).map((option) => (
                        ...
                        >
                          <Text
                            style={{
                              color:
                                formData.gender === option ? ACCENT : "#a0a0a0",
                    ...
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        backgroundColor:
                          formData.gender === null ? "#2e2610" : "transparent",
                        alignItems: "center",
                      }}
                    >
                      <Text
